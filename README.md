...
* [Examples and expositions](https://github.com/StDLabs/MathTools?tab=readme-ov-file#examples-and-expositions) 
  * [Electrostatics of point charges](https://github.com/StDLabs/MathTools#electrostatics-of-point-charges)
...
In this [project](https://github.com/StDLabs/DiscreteElecStat), I am computing and visualizing **electrostatic fields** generated by **arbitrary configurations**
of **point charges** in space. It includes two examples: the electrostatic field of a simple **electric dipole**
and an interplanar area of a perfect **crystalline lattice**.
